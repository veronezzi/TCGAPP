...
public abstract class Hilt_CardDetailFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CardDetailFragment() {
    super();
  }

  Hilt_CardDetailFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CardDetailFragment_GeneratedInjector) this.generatedComponent()).injectCardDetailFragment(UnsafeCasts.<CardDetailFragment>unsafeCast(this));
    }
  }
